...
OPENDENTAL_MYSQL_USER = ""      # Opendental MySQL Server username (Opendental default is 'root')
OPENDENTAL_MYSQL_PASSWORD = ""  # Opendental MySQL Server password
OPENDENTAL_MYSQL_DATABASE = ""  # Opendental MySQL Server DB name (Opendental default is "opendental")
